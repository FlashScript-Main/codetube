...
const Navbar = () => {
    ...
    return (   
        <nav className="flex justify-between items-center px-8 py-4 sticky bg-body-bg-light dark:bg-body-bg-dark top-0 left-0 z-20 border-b border-b-red-600 dark:border-b-blue-400 rounded-r-full rounded-l-full shadow-md shadow-red-500/50 dark:shadow-blue-500/50 mb-4">
            ...
            <div className={`hidden sm:flex gap-2 md:gap-4 lg:gap-8 ${language === "FA" ? "mr-auto ml-4 md:ml-8 lg:ml-10" : "ml-auto mr-4 md:mr-8 lg:mr-10"}`}>
                <ModeToggle />
                <LanguageToggle />
                <PWAToggle />
                <QRCodeLink />
            ...
            <div className={`flex sm:hidden gap-2 md:gap-4 lg:gap-8 ${language === "FA" ? "mr-auto ml-4 md:ml-8 lg:ml-10" : "ml-auto mr-4 md:mr-8 lg:mr-10"}`}>
                <MobileMenu />
            </div>
